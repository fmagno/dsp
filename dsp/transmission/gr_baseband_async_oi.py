...
# Title: Gr Baseband Async Oi
# Generated: Tue Apr 16 11:39:27 2019
...
class gr_baseband_async_oi(gr.top_block):

    def __init__(self, ch_port=1, duration=250000, rx_ip='192.168.5.100', samp_rate=250000, sig_in='./in.dat', sig_out='./out.dat', tx_ip='192.168.5.100'):
        gr.top_block.__init__(self, "Gr Baseband Async Oi")
...
def main(top_block_cls=gr_baseband_async_oi, options=None):
    if options is None:
